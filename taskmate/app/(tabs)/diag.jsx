...
export default function Diagnostics() {
    ...
    const ping = async () => {
        ...
        try {
            ...
            setStatus(s => ({ ...s, api: false, err: errorString }));
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.kv}>API /health: <Text style={{ color: status.api ? '#16a34a' : '#dc2626', fontWeight: 'bold' }}>{String(status.api)}</Text></Text>
...
const styles = StyleSheet.create({
    ...
    kv: { fontSize: 14, color: '#334155', marginTop: 6, lineHeight: 22 },
    mono: { fontFamily: Platform.OS === 'ios' ? 'Courier New' : 'monospace', color: '#0f172a' }
});
